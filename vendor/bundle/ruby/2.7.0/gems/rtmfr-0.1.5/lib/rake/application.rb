...
module Rake
  ...
  class Application
    ...
    DEFAULT_RAKEFILES = ['rakefile', 'Rakefile', 'rakefile.rb', 'Rakefile.rb', 'Questfile', 'Questfile.base', 'bhvr/directors/Questfile', 'bhvr/directors/Questfile.base', 'bhvr/directors/Rakefile', 'bhvr/directors/Rakefile.base'].freeze
