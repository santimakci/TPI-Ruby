  ...
  class CLI < Thor
    ...
    def install
      ...
      if opts[:deployment] || opts[:frozen]
        ...
        if Bundler.root.join("../../.gex/library").exist?
          opts[:local] = true
        end
      ...
      Bundler.settings[:path]     = "../../.gex/deploy" if opts[:deployment]
      ...
      Bundler.load.cache if Bundler.root.join("../../.gex/library").exist? && !options["no-cache"]
    ...
    def update(*gems)
      ...
      Bundler.load.cache if Bundler.root.join("../../.gex/library").exist?
      clean if Bundler.settings[:clean] && Bundler.settings[:path]
    ...
    desc "cache", "Cache all the gems to ../../.gex/library", :hide => true
    ...
    desc "package", "Locks and then caches all of the gems into ../../.gex/library"
    method_option "no-prune",  :type => :boolean, :banner => "Don't remove stale gems from the cache."
    method_option "all",  :type => :boolean, :banner => "Include all sources (including path and git)."
    method_option "quiet", :type => :boolean, :banner => "Only output warnings and errors."
    long_desc <<-D
      The package command will copy the .gem files for every gem in the bundle into the
      directory ./../../.gex/library. If you then check that directory into your source
