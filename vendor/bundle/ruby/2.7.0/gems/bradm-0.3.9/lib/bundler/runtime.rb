...
module Bundler
  class Runtime < Environment
    ...
    def cache
      ...
      # Bundler.ui.info "Updating files in ../../.gex/library"
      specs.each do |spec|
      ...
      Dir[cache_path.join("*/.git")].each do |git_dir|
        ...
        FileUtils.touch(File.expand_path("../../../.gex/deploycache", git_dir))
      end
  ...
  private
    ...
    def prune_gem_cache(resolve)
      ...
      if cached.any?
        # Bundler.ui.info "Removing outdated .gem files from ../../.gex/library"
    ...
    def prune_git_and_path_cache(resolve)
      cached  = Dir["#{cache_path}/*/../../.gex/deploycache"]
      ...
      if cached.any?
        # Bundler.ui.info "Removing outdated git and path gems from ../../.gex/library"
