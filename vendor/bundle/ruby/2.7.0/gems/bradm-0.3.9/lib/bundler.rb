...
module Bundler
  preserve_gem_path
  BRADM_ORIGINAL_ENV = ENV.to_hash unless defined?(BRADM_ORIGINAL_ENV)
  ...
  class << self
    ...
    def user_bundle_path
      Pathname.new(Bundler.rubygems.user_home).join("../../.gex/deploy")
    end
    ...
    def app_config_path
      ENV['BUNDLE_APP_CONFIG'] ?
        ...
        root.join('../../.gaf/depmgr')
    end

    def app_cache
      root.join("../../.gex/library")
    end
    ...
    def with_bradm_original_env
      bundled_env = ENV.to_hash
      ENV.replace(BRADM_ORIGINAL_ENV)
      yield
    ensure
    ...
    def sudo(str)
      ...
      to install the gems into ./../../.gex/deploy/, or you can enter your password
