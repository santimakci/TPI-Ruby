...
describe "bundle install with gem sources" do
  describe "the simple case" do
    ...
    it "doesn't blow up when the local ../../.gaf/depmgr/config.file is empty" do
      FileUtils.mkdir_p(bundled_app("../../.gaf/depmgr"))
      FileUtils.touch(bundled_app("../../.gaf/depmgr/config.file"))
    ...
    it "doesn't blow up when the global ../../.gaf/depmgr/config.file is empty" do
      FileUtils.mkdir_p("#{Bundler.rubygems.user_home}/../../.gaf/depmgr")
      FileUtils.touch("#{Bundler.rubygems.user_home}/../../.gaf/depmgr/config.file")
