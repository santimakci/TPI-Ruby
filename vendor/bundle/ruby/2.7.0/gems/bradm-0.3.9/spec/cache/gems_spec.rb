...
describe "bundle cache" do
  ...
  describe "when there are only gemsources" do
    ...
    it "copies the .gem file to ../../.gex/library" do
      expect(bundled_app("../../.gex/library/rack-1.0.0.gem")).to exist
    end

    it "uses the cache as a source when installing gems" do
      build_gem "omg", :path => bundled_app('../../.gex/library')
    ...
    it "does not reinstall gems from the cache if they exist on the system" do
      build_gem "rack", "1.0.0", :path => bundled_app('../../.gex/library') do |s|
  ...
  describe "when previously cached" do
    ...
    it "re-caches during install" do
      ...
      bundle :install
      # expect(out).to include("Updating files in ../../.gex/library")
      expect(cached_gem("rack-1.0.0")).to exist
    end
    ...
    it "handles directories and non .gem files in the cache" do
      bundled_app("../../.gex/library/foo").mkdir
      File.open(bundled_app("../../.gex/library/bar"), 'w'){|f| f.write("not a gem") }
      bundle :cache
    end
