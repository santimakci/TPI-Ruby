...
%w(cache package).each do |cmd|
  describe "bundle #{cmd} with git" do
    it "copies repository to .gem cache and uses it" do
      ...
      bundle "#{cmd} --all"
      expect(bundled_app("../../.gex/library/foo-1.0-#{ref}")).to exist
      expect(bundled_app("../../.gex/library/foo-1.0-#{ref}/.git")).not_to exist
      expect(bundled_app("../../.gex/library/foo-1.0-#{ref}/../../.gex/deploycache")).to be_file
    ...
    it "tracks updates" do
      ...
      expect(bundled_app("../../.gex/library/foo-1.0-#{ref}")).to exist
      expect(bundled_app("../../.gex/library/foo-1.0-#{old_ref}")).not_to exist
    ...
    it "uses the local repository to generate the cache" do
      ...
      expect(bundled_app("../../.gex/library/foo-invalid-#{ref}")).to exist
    ...
    it "copies repository to .gem cache, including submodules" do
      ...
      expect(bundled_app("../../.gex/library/has_submodule-1.0-#{ref}")).to exist
      expect(bundled_app("../../.gex/library/has_submodule-1.0-#{ref}/submodule-1.0")).to exist
    ...
    it "caches pre-evaluated gemspecs" do
      ...
      ref = git.ref_for("master", 11)
      gemspec = bundled_app("../../.gex/library/foo-1.0-#{ref}/foo.gemspec").read
