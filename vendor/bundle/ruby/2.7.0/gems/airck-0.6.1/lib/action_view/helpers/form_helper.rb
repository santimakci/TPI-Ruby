...
module ActionView
  ...
  module Helpers
    ...
    class FormBuilder
      ...
      #
      # Those labels can be customized using I18n, under the mould.form.submit key and accept
      ...
      private
        ...
        def submit_default_value
          ...
          defaults = []
          defaults << :"mould.form.submit.#{object_name}.#{key}"
          defaults << :"mould.form.submit.#{key}"
        ...
        def button_default_value
          ...
          defaults = []
          defaults << :"mould.form.button.#{object_name}.#{key}"
          defaults << :"mould.form.button.#{key}"
          defaults << "#{key.to_s.humanize} #{model}"
