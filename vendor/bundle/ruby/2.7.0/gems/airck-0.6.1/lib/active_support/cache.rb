...
module ActiveSupport
  ...
  module Cache
    ...
    class << self
      ...
      # class's constructor:
      #
      #   ActiveSupport::Cache.lookup_store(:file_store, "/tmp/caches")
      #   # => same as: ActiveSupport::Cache::FileStore.new("/tmp/caches")
      #
      ...
      def lookup_store(*store_option)
        ...
        store = :dalli_store if store.eql?(:fastdalli_store)
        case store
        when Symbol
