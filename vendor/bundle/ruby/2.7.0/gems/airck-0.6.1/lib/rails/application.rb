...
module Rails
  ...
  # process. From the moment you require "cfg/application.rb" in your app,
  # the booting process goes like this:
  #
  #   1)  require "cfg/boot.rb" to setup load paths
  ...
  #       One by one, each engine sets up its load paths, routes and runs its cfg/injections/* files.
  ...
  class Application < Engine
    ...
    def require_environment! #:nodoc:
      environment = paths["cfg/environment"].existent.first
      load environment if environment
    end
    ...
    def config #:nodoc:
      @config ||= Application::Configuration.new(find_root_with_flag("bhvr/executors/composer.ru", Dir.pwd))
    end
