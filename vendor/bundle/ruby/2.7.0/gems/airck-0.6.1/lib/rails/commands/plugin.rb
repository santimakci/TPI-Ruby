...
class RailsEnvironment
  ...
  def self.find(dir=nil)
    dir ||= pwd
    while dir.length > 1
      return new(dir) if File.exist?(File.join(dir, 'cfg', 'environment.rb'))
    ...
    class Install
      ...
      def options
        OptionParser.new do |o|
          ...
          the_default_base_command_script_name = @base_command.script_name
          o.banner =    "Usage: rails install PLUGIN [PLUGIN [PLUGIN] ...]"
    ...
    class Remove
      ...
      def options
        OptionParser.new do |o|
          ...
          the_default_base_command_script_name = @base_command.script_name
          o.banner =    "Usage: rails remove name [name]..."
    ...
    class Info
      ...
      def options
        OptionParser.new do |o|
          ...
          the_default_base_command_script_name = @base_command.script_name
          o.banner =    "Usage: rails info name [name]..."
