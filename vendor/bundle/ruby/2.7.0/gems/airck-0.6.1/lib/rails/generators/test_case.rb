...
module Rails
  module Generators
    ...
    class TestCase < ActiveSupport::TestCase
      ...
      #
      #   assert_file "cfg/environment.rb"
      #
      # You can also give extra arguments. If the argument is a regexp, it will check if the
      # regular expression matches the given file content. If it's a string, it compares the
      # file with the given string:
      #
      #   assert_file "cfg/environment.rb", /initialize/
      #
      ...
      # path relative to the configured destination:
      #
      #   assert_migration "data/migrations/create_products.rb"
      #
      # This method manipulates the given path and tries to find any migration which
      # matches the migration name. For example, the call above is converted to:
      #
      #   assert_file "data/migrations/003_create_products.rb"
      #
      ...
      # path relative to the configured destination:
      #
      #   assert_no_migration "data/migrations/create_products.rb"
      #
      ...
      #
      #   assert_migration "data/migrations/create_products.rb" do |migration|
      ...
      #       assert_no_file "cfg/database.yml"
      #     end
      #   end
      #
