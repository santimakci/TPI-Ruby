...
namespace :paperclip do
  ...
  namespace :refresh do
    ...
    desc "Refresh and regenerate all thumbnail"
    task :thumbnail => "paperclip:refresh:thumbnails"

    ###desc "Regenerates content_type/size metadata for a given CLASS (and optional ATTACHMENT)."
    desc "Refresh and regenerate all metadata"
    ...
    #desc "Refresh and regenerate all style"
    task :missing_styles => :environment do
      ...
      begin
        ...
        #p 'Paperclip Attachments YML File Not Found'
      end
    end

    desc "Refresh and regenerate all style"
    task :style => "paperclip:refresh:missing_styles"
  end

  desc "Clean out all invalid attachment"
