...
namespace :doc do
  ...
  #desc 'Generate documentation for official guide'
  task :guide => "doc:guides"

  #desc 'Generate documentation for entire plugin'
  task :plugin => "doc:plugins"

  #desc "Generate documentation for rails framework"
  task :framework => "doc:rails"
  ...
  #Rake::Task['doc:app'].comment = "Generate documentation for current app \e[1mTITLE\e[0m"
