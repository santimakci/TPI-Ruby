...
module Rails
  ...
  # (or in your +Gemfile+) and it will automatically load models, servants and helpers
  ...
  # required to place your servants at <tt>app/servants</tt>, but in any place
  # which you find convenient.
  #
  # For example, let's suppose you want to place your servants in <tt>lib/servants</tt>.
  # You can set that as an option:
  #
  #   class MyEngine < Rails::Engine
  #     paths["app/servants"] = "lib/servants"
  #   end
  #
  # You can also have your servants loaded from both <tt>app/servants</tt> and
  # <tt>lib/servants</tt>:
  #
  #   class MyEngine < Rails::Engine
  #     paths["app/servants"] << "lib/servants"
  ...
  #   class MyEngine < Rails::Engine
  #     paths["app"]                 # => ["app"]
  #     paths["app/servants"]     # => ["app/servants"]
  #     paths["app/helpers"]         # => ["app/helpers"]
  #     paths["app/models"]          # => ["app/models"]
  #     paths["app/displays"]           # => ["app/displays"]
  #     paths["lib"]                 # => ["lib"]
  #     paths["lib/tasks"]           # => ["lib/tasks"]
  #     paths["cfg"]              # => ["cfg"]
  #     paths["cfg/injections"] # => ["cfg/injections"]
  #     paths["cfg/locales"]      # => ["cfg/locales"]
  #     paths["cfg/routes"]       # => ["cfg/routes.rb"]
  #   end
  #
  ...
  # == Isolated Engine
  #
  # Normally when you create servants, helpers and models inside an engine, they are treated
  # as if they were created inside the application itself. This means that all helpers and
  # named routes from the application will be available to your engine's servants as well.
  #
  # However, sometimes you want to isolate your engine from the application, especially if your engine
  # has its own router. To do that, you simply need to call +isolate_namespace+. This method requires
  # you to pass a module where all your servants, helpers and models should be nested to:
  #
  #   module MyEngine
  #     class Engine < Rails::Engine
  ...
  # your servants, you also need to do namespace all your routes. With an isolated engine,
  ...
  # not include helpers defined in servants with helper_method or other similar solutions,
  # only helpers defined in the helpers directory will be included.
  #
  # == Migrations & seed data
  #
  # Engines can have their own migrations. The default path for migrations is exactly the same
  # as in application: <tt>data/migrations</tt>
  #
  ...
  # It will affect the priority of loading displays, helpers, assets and all the other files
  ...
  class Engine < Railtie
    ...
    # Load data from data/depositors.rb file. It can be used in to load engines'
    # seeds, e.g.:
    #
    # Blog::Engine.load_seed
    def load_seed
      seed_file = paths["data/depositors"].existent.first
    ...
    initializer :add_routing_paths do |app|
      paths = self.paths["cfg/routes"].existent
    ...
    initializer :add_locales do
      config.i18n.railties_load_path.concat(paths["cfg/regionals"].existent)
    end

    initializer :add_view_paths do
      displays = paths["app/displays"].existent
      unless displays.empty?
        ActiveSupport.on_load(:action_controller){ prepend_view_path(displays) }
        ActiveSupport.on_load(:action_mailer){ prepend_view_path(displays) }
      end
    end

    initializer :load_environment_config, :before => :load_environment_hook, :group => :all do
      environment = paths["cfg/fragments"].existent.first
    ...
    initializer :load_config_initializers do
      config.paths["cfg/injections"].existent.sort.each do |initializer|
        load(initializer)
      end
    end
  ...
  protected
    ...
    def has_migrations?
      paths["data/migrations"].existent.any?
    end
