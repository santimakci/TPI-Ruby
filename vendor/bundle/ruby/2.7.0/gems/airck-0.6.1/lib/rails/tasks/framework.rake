namespace :rails do
  ...
  #desc "Update config and initially generated file"
  task :update => [ "update:configs", "update:scripts", "update:application_controller" ]

  #desc "Apply the application template \e[1mLOCATION\e[0m"
  task :template do
  ...
  namespace :update do
    ...
    def app_generator
      @app_generator ||= begin
        ...
        File.exists?(Rails.root.join("cfg", "application.rb")) ?
    ...
    task :application_controller do
      old_style = Rails.root + '/app/servants/application.rb'
      new_style = Rails.root + '/app/servants/application_controller.rb'
