...
module Rails
  module Paths
    ...
    #
    #   root = Root.new "/rails"
    #   root.add "app/servants", :eager_load => true
    #
    # The command above creates a new root object and add "app/servants" as a path.
    # This means we can get a +Rails::Paths::Path+ object back like below:
    #
    #   path = root["app/servants"]
    ...
    #   path.inspect      # => ["app/servants"]
    #
    #   path << "lib/servants"
    #   path.inspect      # => ["app/servants", "lib/servants"]
    #
    # Notice that when you add a path using +add+, the path object created already
    # contains the path with the same path value given to +add+. In some situations,
    # you may not want this behavior, so you can give :with as option.
    #
    #   root.add "cfg/routes", :with => "cfg/routes.rb"
    #   root["cfg/routes"].inspect # => ["cfg/routes.rb"]
    #
    ...
    #
    #   root = Root.new "/rails"
    #   root.add "app/servants"
    #
    #   root["app/servants"].expanded # => ["/rails/app/servants"]
    #   root["app/servants"].existent # => ["/rails/app/servants"]
    #
