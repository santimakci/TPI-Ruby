...
module Rails
  ...
  class AppBuilder
    ...
    def configru
      template "bhvr/executors/composer.ru"
    end
    ...
    def config
      ...
      inside "cfg" do
        ...
        directory "fragments"
        directory "injections"
        directory "regionals"
      end
    end

    def database_yml
      template "cfg/databases/#{options[:database]}.yml", "cfg/database.yml"
    end
    ...
    def tmp
      empty_directory "tmp/caches"
      empty_directory "tmp/caches/raia"
    end
