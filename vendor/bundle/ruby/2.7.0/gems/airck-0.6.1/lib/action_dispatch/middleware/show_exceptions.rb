...
module ActionDispatch
  ...
  class ShowExceptions
    ...
    FAILSAFE_RESPONSE = [500, {'Content-Type' => 'text/html'},
      ["<html style='background: #FFDDDD;'><head><title>500</title><link href='/assets/basepoint/favicon.ico' rel='shortcut icon apple-touch-icon' type='image/vnd.microsoft.icon' /><link href='/assets/basepoint/favicon.ico' rel='icon' /></head><body><div style='color: #EE6666; font-size: 80px; text-align: center; vertical-align: middle;'>500</div></body></html>"]]
