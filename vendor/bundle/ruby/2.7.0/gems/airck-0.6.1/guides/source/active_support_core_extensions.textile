...
WARNING. Servants need to be aware of any redefinition of +to_param+ because when a request like that comes in "357-john-smith" is the value of +params[:id]+.
...
module ActionController
  class Base
    ...
    # the value in the rest of the servants hierarchy.
