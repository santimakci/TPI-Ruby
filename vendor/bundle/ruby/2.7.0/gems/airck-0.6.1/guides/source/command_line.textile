...
* Generate models, servants, database migrations, and unit tests
...
$ rails new commandsapp
     ...
     create  .gitignore
     create  Rakefile
     create  bhvr/executors/composer.ru
     create  Gemfile
     create  app
     ...
     create  tmp/caches
...
Example:
    ...
    Credit card controller with URLs like /credit_card/debit.
        Controller: app/servants/credit_card_controller.rb
...
Modules Example:
    ...
    Credit card admin controller with URLs like /admin/credit_card/suspend.
        Controller: app/servants/admin/credit_card_controller.rb
...
$ rails generate controller Greetings hello
     create  app/servants/greetings_controller.rb
...
Check out the controller and modify it a little (in +app/servants/greetings_controller.rb+):
...
Examples:
    rails generate model account
            ...
            Migration:  data/migrations/XXX_add_accounts.rb
...
$ rails generate scaffold HighScore game:string score:integer
    ...
    create  app/servants/high_scores_controller.rb
...
dependency  model
    ...
    exists    data/migrations
    create    data/migrations/20100209025147_create_high_scores.rb
</shell>

The generator checks that there exist the directories for models, servants, helpers, layouts, functional and unit tests, stylesheets, creates the views, controller, model and database migration for HighScore (creating the +high_scores+ table and fields), takes care of the route for the *resource*, and new tests for everything.
...
You can also use the alias "z" to invoke the dbconsole: <tt>rails db</tt>.
...
$ rails generate model Oops
      ...
      exists  data/migrations
      create  data/migrations/20081221040817_create_oops.rb
$ rails destroy model Oops
    notempty  data/migrations
    notempty  db
          rm  data/migrations/20081221040817_create_oops.rb
...
...
...
rake tmp:event:clear                       # Clears all files in tmp/events
rake tmp:session:clear                   # Clears all files in tmp/sessions
rake tmp:linkage:clear                    # Clears all files in tmp/linkages
</shell>
...
$ rake notes
(in /home/foobar/commandsapp)
app/servants/admin/users_controller.rb:
...
* +rake tmp:cache:clear+ clears <tt>tmp/caches</tt>.
* +rake tmp:session:clear+ clears <tt>tmp/sessions</tt>.
* +rake tmp:linkage:clear+ clears <tt>tmp/linkages</tt>.
* +rake tmp:clear+ clears all the three: caches, sessions and linkages.
...
add 'Rakefile'
      create  README.rdoc
add 'README.rdoc'
      create  app/servants/application_controller.rb
add 'app/servants/application_controller.rb'
