...
Servants provide the "glue" between models and views. In Rails, servants
...
Action Controller is the component that manages the servants in a Rails
...
|app/|Contains the servants, models, views and assets for your application. You'll focus on this folder for the remainder of this guide.|
|config/|Configure your application's runtime rules, routes, database, and more.  This is covered in more detail in "Configuring Rails Applications":configuring.html|
|bhvr/executors/composer.ru|Rack configuration for Rack based servers used to start the application.|
|data/|Contains your current database schema, as well as the database migrations.|
...
directory in preference to any dynamic content we generate from the servants.
...
Rails how to connect incoming requests to servants and actions. This file
...
application. If you want to create the models, views, and servants for a new
...
|_.File                                       |_.Purpose|
|data/migrations/20100207214725_create_posts.rb    |Migration to create the posts table in your database (your name will include a different timestamp)|
|app/models/post.rb                           |The Post model|
|test/unit/post_test.rb                       |Unit testing harness for the posts model|
|test/fixtures/posts.yml                      |Sample posts for use in testing|
|config/routes.rb                             |Edited to include routing information for posts|
|app/servants/posts_controller.rb          |The Posts controller|
...
generated models, servants, views and other source files. You'll find more
...
If you look in the +data/migrations/20100207214725_create_posts.rb+ file (remember,
...
+app/servants/posts_controller.rb+ and look at the
+index+ action:
...
servants and can be found in +app/views/layouts/application.html.erb+. Open
...
models and servants. To create the new model, run this command in your
terminal:
...
|_.File                                       |_.Purpose|
|data/migrations/20100207235629_create_comments.rb | Migration to create the comments table in your database (your name will include a different timestamp) |
...
| app/servants/comments_controller.rb      | The Comments controller                  |
