...
* I18n for any object - I18n behavior can be added to any object by including <tt>ActiveModel::Translation</tt> and <tt>ActiveModel::Validations</tt>. There is also an <tt>error.message</tt> fallback for translations.
...
* <tt>respond_with</tt> method has now been added to your servants simplifying the venerable +format+ blocks.
