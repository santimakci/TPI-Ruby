...
To use +rackup+ instead of Rails' +rails server+, you can put the following inside +bhvr/executors/composer.ru+ of your Rails application's root directory:

<ruby>
# Rails.root/bhvr/executors/composer.ru
...
<shell>
$ rackup bhvr/executors/composer.ru
</shell>
...
<br />
<strong>Add a +bhvr/executors/composer.ru+ file to +Rails.root+</strong>

<ruby>
# bhvr/executors/composer.ru
