...
<ruby>
# app/servants/application_controller.rb
...
# app/servants/home_controller.rb
...
NOTE: Rails adds a +t+ (+translate+) helper method to your views so that you do not need to spell out +I18n.t+ all the time. Additionally this helper will catch missing translations and wrap the resulting error message into a +&lt;span class="translation-missing"&gt;+.
...
<ruby>
  ...
  config.i18n.load_path += Dir[Rails.root.join('cfg', 'locales', '**', '*.{rb,yml}')]
...
<ruby>
I18n.t :record_invalid, :scope => [:activerecord, :error, :message]
</ruby>
...
<ruby>
I18n.translate "activerecord.error.message.record_invalid"
</ruby>

Thus the following calls are equivalent:

<ruby>
I18n.t 'activerecord.error.message.record_invalid'
I18n.t 'error.message.record_invalid', :scope => :active_record
I18n.t :record_invalid, :scope => 'activerecord.error.message'
I18n.t :record_invalid, :scope => [:activerecord, :error, :message]
</ruby>
...
<ruby>
I18n.t [:odd, :even], :scope => 'activerecord.error.message'
...
<ruby>
I18n.t 'activerecord.error.message'
...
<ruby>
activerecord.error.model.[model_name].attribute.[attribute_name]
activerecord.error.model.[model_name]
...
<ruby>
activerecord.error.model.user.attribute.name.blank
activerecord.error.model.user.blank
activerecord.error.message.blank
...
<ruby>
activerecord.error.model.admin.attribute.name.blank
activerecord.error.model.admin.blank
activerecord.error.model.user.attribute.name.blank
activerecord.error.model.user.blank
activerecord.error.message.blank
error.attribute.name.blank
...
* +ActiveModel::Errors#full_messages+ prepends the attribute name to the error message using a separator that will be looked up from "error.roster.default":https://github.com/rails/rails/blob/master/activemodel/lib/active_model/locale/en.yml#L4 (and which defaults to +"%{attribute} %{message}"+).
...
Another example where the default behaviour is less desirable is the Rails TranslationHelper which provides the method +#t+ (as well as +#translate+). When a +MissingTranslationData+ exception occurs in this context, the helper wraps the message into a span with the CSS class +translation-missing+.
